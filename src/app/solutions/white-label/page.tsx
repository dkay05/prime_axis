  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative rounded-2xl border border-gold-500/20 bg-gradient-to-br from-gold-600/10 via-zinc-900/50 to-purple-600/10 p-10 md:p-14 mb-20 overflow-hidden"
      >
        ...
        <div className="relative z-10 max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-gold-500/10 border border-gold-500/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-gold-400 text-xs font-semibold">White Label Platform</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
            Your Brand. <span className="text-gold-400">Your Platform.</span>
          </h2>
      ...
      <div className="mb-20">
        ...
        >
          <img
            ...
            className="w-full h-auto rounded-2xl border border-zinc-800/50 shadow-2xl shadow-gold-500/10 transition-shadow duration-300 hover:shadow-gold-500/20"
          />
        </motion.div>
      </div>
      ...
      <div className="mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-5">
          {steps.map((s, i) => (
            ...
            >
              <div className="text-3xl font-bold text-gold-500/20 mb-3">{s.num}</div>
