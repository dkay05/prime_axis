  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative rounded-2xl border border-gold-500/20 bg-gradient-to-br from-gold-600/10 via-zinc-900/50 to-cyan-600/10 p-10 md:p-14 mb-20 overflow-hidden"
      >
        ...
        <div className="relative z-10 max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-gold-500/10 border border-gold-500/20 rounded-full px-4 py-1.5 mb-6">
            <Droplets className="w-4 h-4 text-gold-400" />
            <span className="text-gold-400 text-xs font-semibold">Liquidity by SetupFX</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
            End-to-End <span className="text-gold-400">Liquidity Solutions</span>
          </h2>
      ...
      >
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 hover:border-gold-500/30 transition-all duration-300">
          <div className="w-14 h-14 rounded-xl bg-gold-500/10 border border-gold-500/20 flex items-center justify-center mb-6">
            <Plug className="w-7 h-7 text-gold-400" />
          </div>
        ...
        {/* SetupFX Liquidity Provider */}
        <div
          id="setupfx-liquidity"
          className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 hover:border-gold-500/30 transition-all duration-300"
        >
          <div className="w-14 h-14 rounded-xl bg-gold-500/10 border border-gold-500/20 flex items-center justify-center mb-6">
            <Droplets className="w-7 h-7 text-gold-400" />
          </div>
      ...
      <motion.div
        ...
        className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 md:p-10 mb-20 hover:border-gold-500/30 transition-all duration-300"
      >
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={item.title} className="bg-zinc-800/50 border border-zinc-700/50 rounded-xl p-5 text-center">
                <item.icon className="w-6 h-6 text-gold-400 mx-auto mb-3" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {platformCompatibility.map((p, i) => (
            <motion.div
              ...
              className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5 text-center hover:border-gold-500/30 hover:shadow-lg hover:shadow-gold-500/5 transition-all duration-300 group"
            >
              <div className="w-11 h-11 rounded-lg bg-gold-500/10 border border-gold-500/20 flex items-center justify-center mx-auto mb-3 group-hover:bg-gold-500/20 transition-colors">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3">
          {whyChoose.map((item, i) => (
            <motion.div
              ...
              className="flex items-center gap-3 bg-zinc-900/30 border border-zinc-800/50 rounded-lg px-4 py-4"
            >
      ...
      <motion.div
        ...
        className="text-center bg-gradient-to-br from-gold-600/10 via-zinc-900/50 to-cyan-600/5 border border-gold-500/20 rounded-2xl p-10 md:p-14"
      >
