  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-600/10 via-zinc-900/50 to-cyan-600/10 p-10 md:p-14 mb-20 overflow-hidden"
      >
      ...
      >
        ...
        <div
          ...
          className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-300"
        >
          <div className="w-14 h-14 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-6">
      ...
      <motion.div
        ...
        className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 md:p-10 mb-20 hover:border-blue-500/30 transition-all duration-300"
      >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {platformCompatibility.map((p, i) => (
            <motion.div
              ...
              className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-5 text-center hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300 group"
            >
      ...
      <motion.div
        ...
        className="text-center bg-gradient-to-br from-blue-600/10 via-zinc-900/50 to-cyan-600/5 border border-blue-500/20 rounded-2xl p-10 md:p-14"
      >
