    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
              {/* Header */}
              <div className="flex items-center justify-between px-6 pt-6 pb-2">
                <div>
                  <h2 className="text-white text-xl font-bold">Sign In</h2>
                  <p className="text-zinc-400 text-sm mt-1">Welcome back! Please sign in to continue.</p>
                </div>
                <button
                  onClick={onClose}
              ...
              <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    className="flex items-center justify-center gap-2 bg-zinc-800/50 border border-zinc-700 rounded-lg py-2.5 text-zinc-300 text-sm font-medium hover:bg-zinc-800 hover:border-zinc-600 transition-colors"
                  >
